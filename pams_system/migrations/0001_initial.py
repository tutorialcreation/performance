    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('previous_datastructure', models.CharField(blank=True, max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('individual', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='pams_system.KpiParticipants')),
            ],
        ),
        migrations.AddField(
            model_name='kpiparticipants',
            name='levelset',
        ...
        migrations.AddField(
            model_name='kpiparticipants',
            name='parent',
            field=mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='pams_system.KpiParticipants'),
        ),
        migrations.CreateModel(
            name='KpiMembership',
            fields=[
