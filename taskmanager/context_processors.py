from taskmanager.models.tasks import Task,Team,TaskAnalysis,SubTaskAnalysis,SubTask,NotificationSet
...
def get_notifications(request):
    notifications=NotificationSet.objects.filter(viewed=False)
