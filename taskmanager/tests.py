...
#     def test_anybody_can_add(self):
#         self.assertEqual()

#     def test_dropdowns(self):
#         self.assertEqual()

#     def test_not_view_other_departments(self):
#         self.assertEqual()

#     def test_team_leader(self):
#         self.assertEqual()

#     def test_assignment_rating(self):
#         self.assertEqual()

#     def test_independency_assignment(self):
#         self.assertEqual()

#     def test_view_teams_tasks(self):
#         self.assertEqual()
...
# class TestTaskValidations(TestCase):
...
#     def test_team_leader_remove(self):
#         self.assertEqual()

#     def test_new_team_leader(self):
#         self.assertEqual()

#     def test_request_team_delete(self):
#         self.assertEqual()
