...
from taskmanager.views.tasks import (
    ...
    task_accept, task_mark_completed, task_comment, task_delete,send_push,view_push,task_mark_approved,task_mark_revision,TaskCreate,load_members,TaskUpdate,Rating,
    Reassigning,task_resubmit,team_tasks,load_projects,SubTaskRating
)
