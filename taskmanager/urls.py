...
urlpatterns = [
    ...
    path('charts/deadline/', views.deadline_score, name='chart_deadline'),
    path('charts/resubmission/', views.resubmission_score, name='chart_resubmission'),
    path('charts/reset/', views.reset_score, name='chart_reset'),
    path('charts/quality/', views.quality_score, name='chart_quality'),
