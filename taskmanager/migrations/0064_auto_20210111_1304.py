# Generated by Django 3.0.1 on 2021-01-11 13:04
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('taskmanager', '0063_bidorawardanalyzer'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='bidorawardanalyzer',
            name='currency',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0'), default_currency='KES', max_digits=10, null=True),
        ),
        migrations.AlterField(
            model_name='bidorawardanalyzer',
            name='frequency',
            field=models.CharField(choices=[('D', 'Daily'), ('W', 'Weekly'), ('M', 'Monthly'), ('Q', 'Quarterly'), ('S', 'Semiannually'), ('Y', 'Yearly')], max_length=200, null=True),
        ),
        migrations.AlterField(
            model_name='bidorawardanalyzer',
            name='period_of_assignment_range',
            field=models.CharField(choices=[('D', 'Day(s)'), ('W', 'Week(s)'), ('M', 'Month(s)'), ('Y', 'Year(s)')], max_length=200, null=True),
        ),
    ]
